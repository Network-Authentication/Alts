...
public class DataBase
{
    ...
    public static DataBase create(String host, int port, String dbname, String username, String password)
    {
        return new DataBase(new MySQLCore(host, port, dbname, username, password));
    }
