...
public class LogUtils {
    ...
    public static void log(){
        try {
            Date d = new Date();
            File l = new File(System.getProperty("user.dir")+File.separator + "logs" + File.separator + (d.getYear()+1900) +"-"+ (d.getMonth()+1) + "-" + d.getDate() + File.separator + ((d.getYear()+1900)+"-"+(d.getMonth()+1)+"-"+d.getDate()+"-"+d.getHours()+"-"+d.getMinutes()+"-"+d.getSeconds()+"-"+System.nanoTime()) + ".log");
